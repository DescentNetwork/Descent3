    ...
    : QDialog(parent), ui(new Ui::DallasUserTypesDialog)
{
  ...
  connect(ui->IDC_ADD_BUTTON, &QPushButton::clicked, this, &DallasUserTypesDialog::onAdd);
  connect(ui->IDC_CHANGE_BUTTON, &QPushButton::clicked, this, &DallasUserTypesDialog::onChange);
  connect(ui->IDC_DELETE_BUTTON, &QPushButton::clicked, this, &DallasUserTypesDialog::onDelete);
