    ...
    : QDialog(parent), ui(new Ui::TerrainSoundDialog)
{
  ...
  {
    QPushButton *next = ui->IDC_TERRAIN_SOUND_NEXT;
    connect(next, &QPushButton::clicked, this, &TerrainSoundDialog::onNext);
  }
  {
    QPushButton *prev = ui->IDC_TERRAIN_SOUND_PREV;
    connect(prev, &QPushButton::clicked, this, &TerrainSoundDialog::onPrev);
  }
  {
    QComboBox *combo = ui->IDC_TERRAIN_SOUND_COMBO;
...
void TerrainSoundDialog::updateDialog() {
  ...
  {
    QWidget *w = ui->IDC_TERRAIN_SOUND_LOW_ALT;
    w->setEnabled(enabled);
  }
  {
    QWidget *w = ui->IDC_TERRAIN_SOUND_HIGH_ALT;
    w->setEnabled(enabled);
  }
  {
    QWidget *w = ui->IDC_TERRAIN_SOUND_LOW_VOLUME;
    w->setEnabled(enabled);
  }
  {
    QWidget *w = ui->IDC_TERRAIN_SOUND_HIGH_VOLUME;
    w->setEnabled(enabled);
  }

  {
    QLabel *label = ui->IDC_TERRAIN_SOUND_BAND_TEXT;
