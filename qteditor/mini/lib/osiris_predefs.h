...
void osipf_GetGunPos(int objhandle, int gun_number, vector3 *gun_pnt, vector3 *gun_normal = NULL);
...
uint8_t osipf_AIMoveTowardsPosition(int objhandle, vector3 *pos, int *roomnum, float scalar, bool f_bline,
                                  bool f_bline_if_vis);
