...
int CreateAndFireWeapon(vector3 *pos, vector3 *dir, object *parent, int weapon_num);
...
bool WeaponCalcGun(vector3 *gun_point, vector3 *gun_normal, object *obj, int gun_num);
...
void DoWeaponExploded(object *, vector3 *norm = NULL, vector3 *collision_point = NULL, object *hit_object = NULL);

void TimeoutWeapon(object *);

// Creates chidren from a dying weapon
void CreateImpactSpawnFromWeapon(object *obj, vector3 *norm);
