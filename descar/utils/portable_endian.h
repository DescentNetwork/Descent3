...
namespace std
{
  template <typename T> T byteswap(T);
...
template <typename T> constexpr T net_to_host(T x) { return  le_to_host(x); }
template <typename T> constexpr T host_to_net(T x) { return net_to_host(x); }
template <typename T> constexpr T host_to_le (T x) { return  le_to_host(x); }
template <typename T> constexpr T host_to_be (T x) { return  be_to_host(x); }
